number = input("Please enter a series of numbers, \
               using any characters to seperator that is not a number: ")
seperators = ""
...
# we have used the built in function sum() to add all the 
# numbers in our sequence and output the total